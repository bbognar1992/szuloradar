    ...
    op.bulk_insert(
        ...
        [
            ...
            },
            {
                ...
                'name': 'Galaxy Body & Fitness Centrum',
                'type_id': FITNESS_TYPE_ID,
                'rating': Decimal('0.0'),
                'address': '9024 Győr, Kálvária u. 1-3',
                'phone': '+36 96 438-415',
                'hours': 'Hétfő–Szombat: 06:00-23:00; Vasárnap: 12:00-23:00',
                'description': 'Több mint 25 éve működő edzőterem Győrben; a Facebook-oldalon „Kölyökedzés! Konditermi kalandpark! … gyermekeknek és fiataloknak" is szerepel.',
                'maps_link': 'https://maps.google.com/?q=Győr+Kálvária+u.+1-3',
                'latitude': Decimal('47.6880'),
                'longitude': Decimal('17.6390'),
                'created_at': now,
                'updated_at': now,
                'is_approved': True,
            ...
            },
            {
                ...
                'name': 'Butterfly Fitness & Rehab Stúdió',
                'type_id': FITNESS_TYPE_ID,
                'rating': Decimal('0.0'),
                'address': 'Győr/Abda (környék)',
                'phone': None,
                'hours': None,
                'description': 'Kiskiscsoportos gyermek-tréningekkel („SZTM KIDS tréning és terápia … gyermekeknek") is foglalkoznak.',
                'maps_link': None,
                'latitude': None,
                'longitude': None,
                'created_at': now,
            ...
            },
            {
                ...
                'name': 'Golden Ball Club Fitness',
                'type_id': FITNESS_TYPE_ID,
                'rating': Decimal('0.0'),
                'address': '9021 Győr, Szent István út 4',
                'phone': '+36 96 618-100',
                'hours': 'Hétfőtől Vasárnapig: 7:00-22:00',
                'description': 'Fitness terem részleg a szálloda-wellnessben; 14 éves korig „gyermek" kategória is szerepel az áraknál.',
                'maps_link': 'https://maps.google.com/?q=Győr+Szent+István+út+4',
                'latitude': Decimal('47.6885'),
                'longitude': Decimal('17.6395'),
                'created_at': now,
                'updated_at': now,
                'is_approved': True,
                'is_active': True,
            },
            {
                ...
                'type_id': FITNESS_TYPE_ID,
                'rating': Decimal('0.0'),
                'address': 'Győr, (címet később pontosítok)',
                'phone': None,
                'hours': None,
                'description': 'Olyan edzéseket is kínál, mint „Gyerektorna – Győr (WATT FITNESS)", ami utal gyermek-barát szolgáltatásra is.',
                'maps_link': None,
                'latitude': None,
                'longitude': None,
                'created_at': now,
            ...
            },
            {
                ...
                'type_id': FITNESS_TYPE_ID,
                'rating': Decimal('0.0'),
                'address': '9028 Győr, Fehérvári út 10',
                'phone': '+36 96 998-350',
                'hours': None,
                'description': 'Modern edzőterem, mely családias légkört említ „kortól és nemtől függetlenül" a vendéglétszám látogatói között.',
                'maps_link': 'https://maps.google.com/?q=Győr+Fehérvári+út+10',
                'latitude': Decimal('47.6790'),
                'longitude': Decimal('17.6660'),
                'created_at': now,
                'updated_at': now,
                'is_approved': True,
                'is_active': True,
