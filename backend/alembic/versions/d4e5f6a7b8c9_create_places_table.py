    ...
    op.bulk_insert(
        ...
        [
            ...
            },
            {
                ...
                'name': "Jasmine's Fagyizó és Kávézó",
                'type_id': CAFE_TYPE_ID,
                'rating': Decimal('0.0'),
                'address': '9027 Győr, Nagysándor József u. 29.',
                'phone': None,
                'hours': None,
                'description': 'Bababarát és gyerekbarát kávézó: kreatív programok, játék, tanulás, móka a gyermekeknek.',
                'maps_link': 'https://maps.google.com/?q=Győr+Nagysándor+József+u.+29',
                'latitude': Decimal('47.69314'),
                'longitude': Decimal('17.66056'),
                'created_at': now,
                'updated_at': now,
                'is_approved': True,
                'is_active': True,
            },
            {
                ...
                'name': 'A Kutya meg a Macska! Kézműves Kávébár',
                'type_id': CAFE_TYPE_ID,
                'rating': Decimal('0.0'),
                'address': '9022 Győr, Pálffy u. 3-5',
                'phone': '+36 70 622-9477',
                'hours': 'H–Sze: 8:30-20:00; Cs–P: 8:30-22:00; Szo:11:00-22:00; V: 11:00-20:00',
                'description': 'Baba- és gyermekbarát kávézó: pelenkázó, gyereketkészlet, játékok várják a kicsiket.',
                'maps_link': 'https://maps.google.com/?q=Győr+Pálffy+u.+3-5',
                'latitude': Decimal('47.6870'),
                'longitude': Decimal('17.6380'),
                'created_at': now,
                'updated_at': now,
            ...
            },
            {
                ...
                'name': 'Therápia Pékség és Kávézó',
                'type_id': CAFE_TYPE_ID,
                'rating': Decimal('0.0'),
                'address': '9022 Győr, Pálffy u. 3.',
                'phone': None,
                'hours': None,
                'description': 'A hely megfogalmazása szerint „gyerekbarát hely vagyunk".',
                'maps_link': 'https://maps.google.com/?q=Győr+Pálffy+u.+3',
                'latitude': Decimal('47.6870'),
                'longitude': Decimal('17.6380'),
                'created_at': now,
                'updated_at': now,
            ...
            },
            {
                ...
                'name': 'Lipóti Pékség és Kávézó – ETO Park',
                'type_id': CAFE_TYPE_ID,
                'rating': Decimal('0.0'),
                'address': '9024 Győr, Vasvári Pál u. 1',
                'phone': None,
                'hours': None,
                'description': 'Kávézó-pékség, családok részére is kedvelt – említve gyerekhangulatú kávézónak a listákban.',
                'maps_link': 'https://maps.google.com/?q=Győr+Vasvári+Pál+u.+1',
                'latitude': Decimal('47.6940'),
                'longitude': Decimal('17.6500'),
                'created_at': now,
                'updated_at': now,
            ...
            },
            {
                ...
                'name': 'Édenkapu Kávézó & Fagyizó',
                'type_id': CAFE_TYPE_ID,
                'rating': Decimal('0.0'),
                'address': '9026 Győr, Dunakapu tér 4',
                'phone': None,
                'hours': None,
                'description': 'Gyermekbarát kávézó-fagyizó: a kicsik számára játszósarok is rendelkezésre áll.',
                'maps_link': 'https://maps.google.com/?q=Győr+Dunakapu+tér+4',
                'latitude': Decimal('47.6860'),
                'longitude': Decimal('17.6380'),
                'created_at': now,
                'updated_at': now,
                'is_approved': True,
