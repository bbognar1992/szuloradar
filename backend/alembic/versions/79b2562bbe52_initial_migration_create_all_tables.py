...
def upgrade() -> None:
    ...
    op.execute(sa.text("DROP SEQUENCE IF EXISTS amenities_id_seq CASCADE"))
    op.execute(sa.text("CREATE SEQUENCE amenities_id_seq OWNED BY amenities.id"))
    op.execute(sa.text("ALTER TABLE amenities ALTER COLUMN id SET DEFAULT nextval('amenities_id_seq')"))
